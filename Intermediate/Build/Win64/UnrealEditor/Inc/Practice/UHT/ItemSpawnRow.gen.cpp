...
#include "Practice/Public/ItemSpawnRow.h"
...
PRACTICE_API UScriptStruct* Z_Construct_UScriptStruct_FItemSpawnRow();
...
class UScriptStruct* FItemSpawnRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ItemSpawnRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemSpawnRow, (UObject*)Z_Construct_UPackage__Script_Practice(), TEXT("ItemSpawnRow"));
	}
	return Z_Registration_Info_UScriptStruct_ItemSpawnRow.OuterSingleton;
}
template<> PRACTICE_API UScriptStruct* StaticStruct<FItemSpawnRow>()
{
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Practice_Source_Practice_Public_ItemSpawnRow_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FItemSpawnRow::StaticStruct, Z_Construct_UScriptStruct_FItemSpawnRow_Statics::NewStructOps, TEXT("ItemSpawnRow"), &Z_Registration_Info_UScriptStruct_ItemSpawnRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FItemSpawnRow), 3970622260U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Practice_Source_Practice_Public_ItemSpawnRow_h_3221540698(TEXT("/Script/Practice"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Practice_Source_Practice_Public_ItemSpawnRow_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Practice_Source_Practice_Public_ItemSpawnRow_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
